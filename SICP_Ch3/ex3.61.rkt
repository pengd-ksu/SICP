...
;;;;;;;;;;;;;;;
(define invert-cosine (invert-unit-series cosine-series))
(define invert-sine (invert-unit-series sine-series))
(define invert-exp (invert-unit-series exp-series))

(stream-head->list (mul-series invert-cosine cosine-series) 20)
(stream-head->list (mul-series invert-sine sine-series) 20)
(stream-head->list (mul-series invert-exp exp-series) 20)